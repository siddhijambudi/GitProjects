...
public class BlogPostDAO
{
	...
	public void addPostComment(final String name, final String email, final String body, final String permalink)
	{
		...
		WriteResult result = postsCollection.update(new BasicDBObject("permalink", permalink), new BasicDBObject(
			"$push", new BasicDBObject("comments", comment)), false, false);
	}
	...
	public void likePost(final String permalink, final int ordinal)
	{
		...
		postsCollection.update(new BasicDBObject("permalink", permalink), new BasicDBObject("$inc",
