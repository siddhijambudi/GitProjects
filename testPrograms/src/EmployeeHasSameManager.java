...
public class EmployeeHasSameManager
{
	...
	public static void printAllEmployeesOfAllManagers()
	{
		...
		for (Map.Entry<String, TreeNodeEmp> empEntry : empTreeNodeMap.entrySet())
		{
	...
	public static TreeNodeEmp buildHierarchyTreeOfCompany(Map<String, String> empMap,
		Map<String, TreeNodeEmp> empTreeNodeMap)
	{
